      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-value">￥{{todayList.daySumMemberIncome || 0}}</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="total-frame">
    ...
    created(){
      ...
      vue.$http.post(vue, '/rest/member/statistics/todayStatistic', {},
        (vue, data) => {
          ...
          vue.todayList.daySumMemberIncome = data.data.daySumMemberIncome;
      ...
      //查询订单统计数据
      vue.$http.post(vue, '/rest/member/order/statistic', {},
        (vue, data) => {
