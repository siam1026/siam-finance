        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px" class="login-container">
            ...
            <el-form-item class="handelButton">
                <!-- <el-col :span="12" style="text-align: left;">
                    <el-button type="text" @click.native.prevent="$router.push('/QuickLogin')" :loading="logining">免费注册</el-button>
                </el-col> -->
                <el-col :span="12" style="text-align: left;">
                    <el-button type="text" @click.native.prevent="$router.push('/QuickLogin')">没有账号？去注册</el-button>
                </el-col>
    ...
    methods: {
      ...
      handleSubmit(ev) {
        ...
        this.$refs.ruleForm.validate((valid) => {
          ...
          //   }
          //   vue.$http.post(vue, '/rest/member/login', companyInfo,
          //     (vue, data)=> {
          //       vue.logining = false;
          //       vue.$message({
          //         showClose: true,
          ...
          if (valid) {
            ...
            vue.$http.post(vue, '/rest/member/login', user,
              (vue, data)=> {
      ...
      getUserInfo(token) {
        let vue = this
        vue.$http.post(vue, '/rest/member/getLoginMemberInfo', {"token" : token},
          (vue, data)=> {
            let user = data.data
