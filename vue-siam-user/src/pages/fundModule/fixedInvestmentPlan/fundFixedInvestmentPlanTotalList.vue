...
<script>
import tabZujianChild0 from './notStartedFundFixedInvestmentPlanList.vue'
import tabZujianChild1 from './runningFundFixedInvestmentPlanList.vue'
import tabZujianChild2 from './liquidatedFundFixedInvestmentPlanList.vue'
import tabZujianChild3 from './completedFundFixedInvestmentPlanList.vue'
  export default {
    components:{
