...
<script>
import tabZujianChild0 from './notStartedConvertibleBondFixedInvestmentPlanList.vue'
import tabZujianChild1 from './runningConvertibleBondFixedInvestmentPlanList.vue'
import tabZujianChild2 from './liquidatedConvertibleBondFixedInvestmentPlanList.vue'
import tabZujianChild3 from './completedConvertibleBondFixedInvestmentPlanList.vue'
  export default {
    components:{
