...
<script>
import tabZujianChild0 from './notStartedStockFixedInvestmentPlanList.vue'
import tabZujianChild1 from './runningStockFixedInvestmentPlanList.vue'
import tabZujianChild2 from './liquidatedStockFixedInvestmentPlanList.vue'
import tabZujianChild3 from './completedStockFixedInvestmentPlanList.vue'
  export default {
    components:{
