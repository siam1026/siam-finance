	...
	export default {
		...
		methods: {
			...
			getList(pageNoParam) { // 获取列表
				...
				vue.$http.post(vue, '/rest/member/rider/list', param,
					(vue, data) => {
			...
			handleDel (id) { // 删除
				...
				vue.$http.delete(vue, '/rest/member/rider/delete', {"ids" : [id]},
					function(vue, data) {
						vue.$message({
							showClose: true,
							message: data.message,
