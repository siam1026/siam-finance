	...
	export default {
      ...
      updateSpecification(item) {
        ...
        delete param.updateTime;
				vue.$http.post(vue, '/rest/member/goodsSpecificationOption/update', param,
					function(vue, data) {
            vue.$message({
              showClose: true,
      ...
      removeSpecification(item) {
        ...
        // alert(JSON.stringify(item));
				vue.$http.post(vue, '/rest/member/goodsSpecificationOption/delete', {"ids": [data.id]},
					function(vue, data) {
            vue.$message({
              showClose: true,
              message: data.message,
      ...
      addSpecification(row) { // 新增规格
        ...
        let url = ''
        param.id ? url = '/rest/member/goodsSpecificationOption/update' : url = '/rest/member/goodsSpecificationOption/insert'
      ...
      updateStatus(row, status=1) {
        ...
        this.$confirm('确认'+ NoticeTitle +' ‘ '+ row.name +' ’ ?', '提示', {
          ...
          vue.$http.post(vue, '/rest/member/goods/update', param,
            function(vue, data) {
              vue.$message({
                showClose: true,
                message: data.message,
      ...
      getList(pageNoParam) { // 获取列表
        ...
        console.log("searchMsg="+JSON.stringify(vue.searchMsg));
				...
				vue.$http.post(vue, '/rest/member/goods/list', param,
					(vue, data) => {
          ...
          $.ajax({
			...
			handleDel (id) { // 删除
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					// this.listLoading = true;
				let vue = this;
				vue.$http.post(vue, '/rest/member/goods/delete', {"id":id},
					function(vue, data) {
            vue.$message({
              showClose: true,
              message: data.message,
      ...
      getspecificationList() {
        ...
        vue.$http.post( vue, '/rest/member/goodsSpecificationOption/list', param,
          (vue, data) => {
