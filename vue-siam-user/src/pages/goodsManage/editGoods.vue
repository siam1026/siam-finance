    ...
    saveGoodsMsg() {
      this.$refs.editForm.validate((valid) => {
        if (valid) {
          ...
          let url = "";
          param.id
            ? (url = "/rest/member/goods/update")
            : (url = "/rest/member/goods/insert");
          vue.$http.post(
            vue,
            url,
            param,
