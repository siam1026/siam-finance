	...
	export default {
		...
		methods: {
			...
			getList(pageNoParam) { // 获取列表
				...
				vue.$http.post(vue, '/rest/member/goodsRawmaterialRelation/find/goodsRawmaterialRelation', param,
					(vue, data) => {
			...
			handleDetail (goodsId) { // 查看原料配比详情，刷新右侧列表
				...
				vue.$http.post(vue, '/rest/member/goodsRawmaterialRelation/find/goodsRawmaterialRelationByGoodsId', param,
					function(vue, data) {
			...
			handleDel (id) { // 删除
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					let vue = this;
					vue.$http.delete(vue, '/rest/member/goodsRawmaterialRelation/delete', {"id" : id},
						function(vue, data) {
							vue.$message({
								showClose: true,
								message: data.message,
			...
			editSubmit: function () { // 编辑
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						...
						url = '/rest/member/goodsRawmaterialRelation/update';
			...
			getListRelationTable() { // 获取原料配比列表
				...
				vue.$http.post(vue, '/rest/member/rawmaterial/list', param,
					(vue, data) => {
			...
			editSubmitRelationTable: function () { // 原料配比保存事件
				...
				url = '/rest/member/goodsRawmaterialRelation/insert';
