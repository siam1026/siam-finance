...
@RestController
@RequestMapping(value = "/rest/admin/convertibleBond")
@Transactional(rollbackFor = Exception.class)
@Api(tags = "基金信息模块相关接口", description = "ConvertibleBondController")
public class AdminConvertibleBondController {
    ...
    public BasicResult syncPrice(@RequestBody @Validated(value = {}) ConvertibleBondParam param) {
        fundService.syncPrice(param.getIsOptional());
        return BasicResult.success();
    }
