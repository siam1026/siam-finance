...
/**
 * 股票短期交易/做T交易记录表(一个做T买入记录可能对应多个做T卖出操作)实例类
 *
 * @author JiangP
 * @date 2022/01/23 21:48
 */
@Data
@TableName("tb_stock_shortterm_trading")
public class StockShorttermTrading implements Serializable {
