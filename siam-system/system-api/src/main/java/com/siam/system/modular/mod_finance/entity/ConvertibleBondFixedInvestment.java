 ...
 */
@Data
@TableName("tb_convertible_bond_fixed_investment")
public class ConvertibleBondFixedInvestment implements Serializable {
    ...
    public String toString() {
        return "ConvertibleBondFixedInvestment{" +
                "id=" + id +
                ", planId=" + planId +
