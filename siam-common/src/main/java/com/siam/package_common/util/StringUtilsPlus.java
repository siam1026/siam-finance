...
public class StringUtilsPlus {
    ...
    public static boolean isNumeric(String s) {
        if (StringUtilsPlus.hasText(s)) {
            return StringUtilsPlus.PATTERN_ISNUMERIC.matcher(s).matches();
        } else {
            return false;
        }
    }
    ...
    public static boolean isAlphameric(final String s) {
        if (StringUtilsPlus.hasText(s)) {
            return StringUtilsPlus.PATTERN_ISALPHAMERIC.matcher(s).matches();
        } else {
            return false;
        }
    }
    ...
    public static boolean isLoginName(final String s) {
        return StringUtilsPlus.PATTERN_ISLOGINNAME.matcher(s).matches();
    }
    ...
    public static boolean isName(final String s) {
        return StringUtilsPlus.PATTERN_ISNAME.matcher(s).matches();
    }
    ...
    public static boolean isEmail(final String s) {
        ...
        return StringUtilsPlus.PATTERN_ISEMAIL.matcher(s).matches();
    }
    ...
    public static boolean isURL(final String s) {
        return StringUtilsPlus.PATTERN_ISURL.matcher(s).matches();
    }
    ...
    public static int intPositiveValue(final String s) {
        int retInt = StringUtilsPlus.intValue(s, 10);
        if (retInt < 0) {
            retInt = -retInt;
        }
        return retInt;
    ...
    public static int intValue(final String s) {
        return StringUtilsPlus.intValue(s, 10);
    }
    ...
    public static long longValue(final String s) {
        return StringUtilsPlus.longValue(s, 10);
    }
    ...
    public static String trim(final String s) {
        ...
        return StringUtilsPlus.PATTERN_TRIM.matcher(s).replaceAll("");
    }
    ...
    public static String trimLeft(final String s) {
        ...
        return StringUtilsPlus.PATTERN_TRIM_LEFT.matcher(s).replaceAll("");
    }
    ...
    public static String trimRight(final String s) {
        ...
        return StringUtilsPlus.PATTERN_TRIM_RIGHT.matcher(s).replaceAll("");
    }
    ...
    public static String htmlEncode(final String s) {
        return StringUtilsPlus.htmlEncode(s, false);
    }
    ...
    /**
     * 处理字符串。
     * 如果第二个参数为false，则返回 StringUtilsPlus.htmlEncode(s, true) 的结果；否则只将回车替换为&lt;br&gt; 然后返回
     */
    public static String textareaFilter(String s, boolean html) {
        if (!html) {
            return StringUtilsPlus.htmlEncode(s, true);
        } else {
            if (s == null) {
                return "";
            }
    ...
    public static String[] split(final String str, final String connector) {
        if (!StringUtilsPlus.hasText(str)) {
            return new String[0];
        }
...
//		String reg = "(?i)<embed (.+?)src=(.+?.(\\.swf))(.+?)>";
    ...
    public static boolean isBetweenNowTime(String start, String end) {
        return isBetweenTime(StringUtilsPlus.formatDate(new Date()), start, end);
    }
    ...
    public static String findShortKey(String keys) {
        ...
        String[] keysArray = StringUtilsPlus.split(keys, ",");
        if (keysArray.length <= 1) {
            return StringUtilsPlus.nvl(keysArray[0]);
        }
        String minKey = "";
        for (int i = 0; i < keysArray.length; i++) {
            String tempKey = StringUtilsPlus.nvl(keysArray[i]).trim();
            if (tempKey.equals("")) {
                continue;
            }
            if (minKey.equals("")) {
    ...
    public static String middleReplaceStar(String phone) {
        String result = null;
        if (!StringUtilsPlus.isEmpty(phone)) {
            if (phone.length() < 7) {
                result = phone;
            } else {
